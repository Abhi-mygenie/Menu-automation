...
const MockupApp = lazy(() => import("@/MockupApp"));
    ...
    <div className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <header className="border-b border-stone-200 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <a
              data-testid="review-tool-link"
              href="/review"
              className="flex items-center gap-1.5 rounded-md bg-[#002FA7] px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-[#0026a0]"
            >
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/review/:datasetId" element={<ReviewWorkspace />} />
          <Route path="/mockup/*" element={<Suspense fallback={<div className="flex items-center justify-center min-h-screen text-slate-400">Loading mockup...</div>}><MockupApp /></Suspense>} />
        </Routes>
      </BrowserRouter>
    </div>
  );
